...
export function TourPageNav({ tourId, active }: Props) {
  return (
    <>
      <Link href={`/dashboard/tours/${tourId}`} style={{ ...itemStyle(active === "gigs"), border: "3px solid var(--hw-border-strong)", ...(active === "gigs" ? { padding: "14px 28px", fontSize: 16, letterSpacing: "2px" } : {}) }}>
        GIGS DASHBOARD
      </Link>
