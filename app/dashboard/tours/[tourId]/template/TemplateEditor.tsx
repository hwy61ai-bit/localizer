...
function buildPreviewUrl(publicId: string, cloudName: string, cfg: FormatConfig, format: FormatKey): string {
  ...
  const layers = [
    ...
    `c_fit,co_rgb:${color},fl_layer_apply,g_center,l_text:${font}_${cfg.venue.size}_bold:${san("Stubbs Waller Creek Amphitheater")},w_${maxW},x_${vp.xPx},y_${vp.yPx}`,
    `c_fit,co_rgb:${color},fl_layer_apply,g_center,l_text:${font}_${cfg.date.size}:${san("April 25 2026")},w_${maxW},x_${dp.xPx},y_${dp.yPx}`,
