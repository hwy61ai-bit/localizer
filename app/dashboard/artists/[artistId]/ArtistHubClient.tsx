  ...
  const backLink = (
    <div style={{ padding: "16px 24px 0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <span style={{ fontSize: 14, fontWeight: 800, color: "#111" }}>{artistName}</span>
        <a
          href={`/dashboard/artists/${artistId}/profile`}
          style={{ display: "inline-flex", color: "#999", textDecoration: "none" }}
