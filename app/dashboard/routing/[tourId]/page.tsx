          ...
          <div style={{ background: "var(--hw-bg-surface)", border: "3px solid var(--hw-border-strong)", padding: 20, marginBottom: 16 }}>
            ...
            {(!tour.tour_vehicles || tour.tour_vehicles.length === 0) && (
              <div style={{ borderTop: "3px solid var(--hw-border-strong)", marginTop: 12, paddingTop: 8 }}>
                <div onClick={() => setShowLegacyVehicle(!showLegacyVehicle)} style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", cursor: "pointer", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: showLegacyVehicle ? 10 : 0 }}>
                ...
                {showLegacyVehicle && (
                  <div className="td-settings-grid-5" style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12 }}>
                    <div>
                      <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Vehicle</label>
                    ...
                    <div>
                      <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Passengers</label>
                    ...
                    <div>
                      <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>MPG</label>
                    ...
                    <div>
                      <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Fuel $/gal</label>
                    ...
                    <div>
                      <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Fly threshold (h)</label>
            ...
            <div style={{ borderTop: "3px solid var(--hw-border-strong)", paddingTop: 16, marginTop: 16 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                ...
                <button
                  ...
                  style={{ padding: "4px 10px", fontSize: 11, fontWeight: 600, fontFamily: "var(--hw-font-display)", letterSpacing: "2px", textTransform: "uppercase", border: "3px solid var(--hw-border-strong)", background: "var(--hw-bg-surface)", cursor: "pointer" }}
                >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 120px 1fr 120px", gap: 8, alignItems: "center" }}>
                <div>
                  <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>Show Day Label</div>
                  <input
                ...
                <div>
                  <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>$/Show Day</div>
                  <input
                ...
                <div>
                  <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>Off Day Label</div>
                  <input
                    style={{ width: "100%", boxSizing: "border-box", padding: "4px 8px", border: "3px solid var(--hw-border-strong)", fontSize: 13, fontFamily: "var(--hw-font-body)", outline: "none" }}
                ...
                <div>
                  <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>$/Off Day</div>
                  <input
                    style={{ width: "100%", boxSizing: "border-box", padding: "4px 8px", border: "3px solid var(--hw-border-strong)", fontSize: 13, fontFamily: "var(--hw-font-mono)", textAlign: "right" as const, outline: "none" }}
                    type="number"
              ...
              {blanketDetail && (
                <div style={{ marginTop: 12, background: "var(--hw-bg)", padding: 12 }}>
                  ...
                  {tour?.tour_roster && tour.tour_roster.length > 0 && (
                    <div style={{ marginTop: 8, fontSize: 11, fontFamily: "var(--hw-font-mono)", color: "var(--hw-amber)", padding: "4px 8px", background: "var(--hw-amber-ghost)" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: showCommissions ? 12 : 0 }}>
                ...
                {showCommissions && (
                  <button
                    ...
                    style={{ padding: "4px 12px", border: "3px solid var(--hw-bg-invert)", background: "var(--hw-bg-invert)", color: "var(--hw-bg-surface)", fontFamily: "var(--hw-font-display)", fontSize: 11, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer" }}
                  ...
                  {(tour?.tour_commissions || []).map((c, idx) => {
                    ...
                    return (
                      <div key={c.id} className="td-commission-row" style={{ display: "grid", gridTemplateColumns: "1fr 140px 1fr 100px 60px 40px 30px", gap: 6, alignItems: "end", marginBottom: 8, padding: "8px 0", borderBottom: "3px solid var(--hw-border)" }}>
                        <div>
                          <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>Label</div>
                        ...
                        <div>
                          <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>Type</div>
                          <select value={c.type} onChange={(e) => updateCommission("type", e.target.value)} style={{ width: "100%", boxSizing: "border-box", padding: "6px 4px", border: "3px solid var(--hw-border-strong)", fontSize: 11, fontFamily: "var(--hw-font-body)", background: "var(--hw-bg-surface)", outline: "none" }}>
                            {Object.entries(COMMISSION_TYPE_LABELS).map(([k, v]) => <option key={k} value={k}>{v}</option>)}
                          </select>
                        </div>
                        <div>
                          <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>Recipient</div>
                        ...
                        <div>
                          {(isPct || isCustom) && (
                            <>
                              <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>%</div>
                          ...
                          {(isFlat || isCustom) && !isPct && (
                            <>
                              <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>$ Flat</div>
                        ...
                        <div>
                          {isFlat && (
                            <>
                              <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, color: "var(--hw-text-muted)", marginBottom: 2, letterSpacing: "1.5px", textTransform: "uppercase" }}>Period</div>
                              <select value={c.flatPeriod || "monthly"} onChange={(e) => updateCommission("flatPeriod", e.target.value)} style={{ width: "100%", boxSizing: "border-box", padding: "6px 2px", border: "3px solid var(--hw-border-strong)", fontSize: 10, fontFamily: "var(--hw-font-body)", background: "var(--hw-bg-surface)", outline: "none" }}>
            ...
            {flags.advancing && <div style={{ borderTop: "3px solid var(--hw-border-strong)", marginTop: 16, paddingTop: 16 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12 }}>
                <div>
                  <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Initial (days before)</label>
                ...
                <div>
                  <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Follow-up 1 (days)</label>
                ...
                <div>
                  <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Follow-up 2 (days)</label>
                ...
                <div>
                  <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Final nudge (days before)</label>
                ...
                <thead>
                  <tr style={{ background: "var(--hw-bg-invert)" }}>
                    {["#", "Date", "Event / Venue", "City", "Country", "Offer", "USD", "Status", "Cap", "Adv", ""].map((h) => (
                      <th key={h || "del"} style={{ padding: "12px 12px", textAlign: "left", fontFamily: "var(--hw-font-mono)", fontSize: 10, fontWeight: 700, color: "var(--hw-text-invert)", textTransform: "uppercase", letterSpacing: "2px", whiteSpace: "nowrap" }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
            ...
            <div style={{ padding: "0 24px 24px" }}>
                ...
                <div style={{ paddingBottom: 14, marginTop: -10 }}>
                  ...
                  {!!(drawerShow as Record<string, unknown>).hotel_block && (
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 6, paddingLeft: 24 }}>
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Block Size</label>
                      ...
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Block Rate ($)</label>
                      ...
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Cutoff Date</label>
                      ...
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Attrition %</label>
              ...
              {flags.settlement && drawerShow && !drawerShow.is_off && (
                <div style={{ borderBottom: "3px solid var(--hw-border)", padding: "0 0 14px" }}>
                  <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, fontWeight: 400, textTransform: "uppercase", letterSpacing: "2px", color: "var(--hw-text-muted)", padding: "14px 0", cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center" }} onClick={() => setSettlementOpen(!settlementOpen)}>
                    Settlement
              ...
              {flags.depositTracking && drawerShow && !drawerShow.is_off && (
                <div style={{ borderBottom: "3px solid var(--hw-border)" }}>
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, fontWeight: 400, textTransform: "uppercase", letterSpacing: "2px", color: "var(--hw-text-muted)" }}>Deposits</div>
                      {(() => {
                  ...
                  {!collapsedSections.has("Deposits") && (
                    <div style={{ paddingBottom: 14, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Amount</label>
                      ...
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Currency</label>
                      ...
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Status</label>
                        {(() => {
                      ...
                      <div>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Collected By</label>
                      ...
                      <div style={{ gridColumn: "1 / -1" }}>
                        <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Notes</label>
              ...
              {flags.advancing && drawerShow && !drawerShow.is_off && (() => {
                ...
                <div style={{ borderBottom: "3px solid var(--hw-border)" }}>
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, fontWeight: 400, textTransform: "uppercase", letterSpacing: "2px", color: "var(--hw-text-muted)" }}>Advancing</div>
                      <span style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, fontWeight: 700, padding: "2px 8px", background: statusBg, color: statusColor }}>{statusLabel}</span>
                      {isPaused && <span style={{ fontFamily: "var(--hw-font-mono)", fontSize: 10, fontWeight: 700, padding: "2px 8px", background: "var(--hw-bg)", color: "var(--hw-text-muted)" }}>Paused</span>}
                    </div>
                  ...
                  {!collapsedSections.has("Advancing") && (
                    <div style={{ paddingBottom: 14 }}>
                      ...
                      <div style={{ display: "flex", gap: 6, marginBottom: 10, marginTop: 8 }}>
                        ...
                        {as !== "confirmed" && (
                          <button
                            ...
                            style={{ padding: "4px 12px", border: "3px solid var(--hw-green)", background: "var(--hw-bg-surface)", color: "var(--hw-green)", fontFamily: "var(--hw-font-display)", fontWeight: 700, fontSize: 11, letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer", marginLeft: 8 }}
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 8 }}>
                        <div>
                          <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Recipient Email</label>
                        ...
                        <div>
                          <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Recipient Name</label>
                      ...
                      {drawerShow.advance_form_token && (
                        <div style={{ marginTop: 10 }}>
                          <label style={{ fontFamily: "var(--hw-font-mono)", fontSize: 11, color: "var(--hw-text-muted)", display: "block", marginBottom: 4, letterSpacing: "1.5px", textTransform: "uppercase" }}>Advance Form Link</label>
                          <div style={{ display: "flex", gap: 6 }}>
                            <input readOnly value={`${window.location.origin}/advance/${drawerShow.advance_form_token}`} style={{ flex: 1, padding: "6px 10px", border: "3px solid var(--hw-border-strong)", fontSize: 11, fontFamily: "var(--hw-font-mono)", color: "var(--hw-text-muted)", outline: "none" }} />
                            <button onClick={() => navigator.clipboard.writeText(`${window.location.origin}/advance/${drawerShow.advance_form_token}`)} style={{ padding: "6px 12px", border: "3px solid var(--hw-border-strong)", background: "var(--hw-bg-surface)", fontFamily: "var(--hw-font-display)", fontSize: 11, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer" }}>Copy</button>
                          </div>
                        </div>
                      )}
                    </div>
          ...
          <td colSpan={11} style={{ padding: 0, borderBottom: "3px solid var(--hw-border-strong)" }}>
            <div style={{
              ...
              {leg.driveH !== null && leg.driveH > 6 && !flying && (
                <span style={{ background: "var(--hw-crimson)", color: "var(--hw-text-invert)", padding: "2px 10px", fontFamily: "var(--hw-font-mono)", fontSize: 9, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase" }}>BRUTAL</span>
              )}
