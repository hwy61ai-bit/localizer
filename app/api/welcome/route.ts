    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; padding: 40px 32px; border-radius: 12px;">
        ...
        <p style="color: #888; font-size: 15px; line-height: 1.7; margin: 0 0 32px 0;">
          You're in. Here's how to get your first show graphics out in under 5 minutes:
        </p>
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 32px;">
          <tr>
            ...
            <td style="padding: 14px 0; border-bottom: 1px solid #1a1a1a; color: #f0ede8; font-size: 14px;">Add your artist and upload a tour poster image</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="padding: 14px 0; color: #f0ede8; font-size: 14px;">Hit Generate All — graphics go out to every venue automatically</td>
          </tr>
        </table>
