    ...
    <div style={{ background: "var(--hw-bg)", minHeight: "100vh", color: "var(--hw-text)" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <div style={{ padding: "24px 0 20px", borderBottom: "3px solid var(--hw-border-strong)", marginBottom: 32, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <span style={{ fontFamily: "var(--hw-font-mono)", fontSize: 13, fontWeight: 400, color: "var(--hw-text-muted)", letterSpacing: "4px", textTransform: "uppercase" }}>Tour Marketing Kit</span>
        </div>

        {/* Hero */}
        <div style={{ marginBottom: 48, border: "3px solid var(--hw-border-strong)", padding: 28, background: "var(--hw-bg-surface)" }}>
          <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 13, fontWeight: 400, color: "var(--hw-blue)", letterSpacing: "4px", textTransform: "uppercase", marginBottom: 8 }}>Tour Marketing Kit</div>
          ...
          <div style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
            {dateRange && (
              <div>
                <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 13, fontWeight: 400, color: "var(--hw-text-muted)", marginBottom: 3, textTransform: "uppercase", letterSpacing: "1.5px" }}>Date Range</div>
                <div style={{ fontFamily: "var(--hw-font-body)", fontSize: 15, fontWeight: 400, color: "var(--hw-text-secondary)" }}>{dateRange}</div>
              </div>
            )}
            <div>
              <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 13, fontWeight: 400, color: "var(--hw-text-muted)", marginBottom: 3, textTransform: "uppercase", letterSpacing: "1.5px" }}>Shows</div>
        ...
        {/* Shows */}
        <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 13, fontWeight: 400, color: "var(--hw-blue)", letterSpacing: "4px", textTransform: "uppercase", marginBottom: 20 }}>Shows</div>
        {eventList.length === 0 ? (
              ...
              const cardContent = (
                <>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {(evCity || evState) && (
                      <div style={{ fontFamily: "var(--hw-font-mono)", fontSize: 13, color: "var(--hw-text-muted)", textTransform: "uppercase", letterSpacing: "1px" }}>{[evCity, evState].filter(Boolean).join(", ")}</div>
                    )}
                  </div>
                  {isReady ? (
                    <span style={{ background: "#2d7a3d", color: "#fff", fontFamily: "var(--hw-font-mono)", fontSize: 12, letterSpacing: "2px", textTransform: "uppercase", padding: "6px 12px", border: "2px solid var(--hw-border-strong)", whiteSpace: "nowrap" }}>Ready</span>
                  ) : (
                    <span style={{ background: "#888", color: "#fff", fontFamily: "var(--hw-font-mono)", fontSize: 12, letterSpacing: "2px", textTransform: "uppercase", padding: "6px 12px", border: "2px solid var(--hw-border-strong)", whiteSpace: "nowrap" }}>Rendering</span>
                  )}
                </>
              );
