...
export const CITY_AIRPORTS: Record<string, string> = {
  ...
  'cedar rapids': 'CID', 'iowa city': 'CID', 'asheville': 'AVL',
  'chattanooga': 'CHA', 'birmingham': 'BHM', 'bozeman': 'BZN',
  'missoula': 'MSO', 'great falls': 'GTF', 'kalispell': 'FCA',
  'steamboat springs': 'HDN', 'grand junction': 'GJT', 'aspen': 'ASE',
  'durango': 'DRO', 'jackson hole': 'JAC', 'rapid city': 'RAP',
  'sioux falls': 'FSD', 'fargo': 'FAR', 'bismarck': 'BIS', 'billings': 'BIL',
  'eugene': 'EUG', 'bend': 'RDM', 'medford': 'MFR', 'redding': 'RDD',
  'fresno': 'FAT', 'santa barbara': 'SBA', 'monterey': 'MRY',
  'san luis obispo': 'SBP', 'palm springs': 'PSP', 'reno': 'RNO',
  'tucson': 'TUS', 'flagstaff': 'FLG', 'little rock': 'LIT',
  'fayetteville': 'XNA', 'tulsa': 'TUL', 'wichita': 'ICT',
  'des moines': 'DSM', 'madison': 'MSN', 'green bay': 'GRB',
  'appleton': 'ATW', 'grand rapids': 'GRR', 'traverse city': 'TVC',
  'kalamazoo': 'AZO', 'fort wayne': 'FWA', 'south bend': 'SBN',
  'lexington': 'LEX', 'knoxville': 'TYS', 'tri-cities': 'TRI',
  'greenville': 'GSP', 'charleston': 'CHS', 'savannah': 'SAV',
  'jacksonville': 'JAX', 'pensacola': 'PNS', 'mobile': 'MOB',
  'shreveport': 'SHV', 'baton rouge': 'BTR', 'dayton': 'DAY',
  'akron': 'CAK', 'harrisburg': 'MDT', 'burlington': 'BTV',
  'portland me': 'PWM', 'bangor': 'BGR',
  // Canada
...
export const AIRPORT_COORDS: Record<string, [number, number]> = {
  ...
  // Regional US airports
  'CID': [41.8847, -91.7108], 'AVL': [35.4362, -82.5418], 'CHA': [35.0353, -85.2038],
  'BHM': [33.5629, -86.7535], 'BZN': [45.7775, -111.1530], 'MSO': [46.9163, -114.0906],
  'GTF': [47.4820, -111.3707], 'FCA': [48.3105, -114.2560], 'HDN': [40.4812, -106.8663],
  'GJT': [39.1224, -108.5267], 'ASE': [39.2232, -106.8689], 'DRO': [37.1515, -107.7538],
  'JAC': [43.6073, -110.7378], 'RAP': [44.0453, -103.0574], 'FSD': [43.5820, -96.7419],
  'FAR': [46.9207, -96.8158], 'BIS': [46.7727, -100.7460], 'BIL': [45.8077, -108.5430],
  'EUG': [44.1246, -123.2119], 'RDM': [44.2541, -121.1500], 'MFR': [42.3742, -122.8735],
  'RDD': [40.5090, -122.2934], 'FAT': [36.7762, -119.7181], 'SBA': [34.4262, -119.8414],
  'MRY': [36.5870, -121.8430], 'SBP': [35.2368, -120.6424], 'PSP': [33.8297, -116.5067],
  'RNO': [39.4991, -119.7681], 'TUS': [32.1161, -110.9410], 'FLG': [35.1385, -111.6712],
  'LIT': [34.7294, -92.2243], 'XNA': [36.2819, -94.3068], 'TUL': [36.1984, -95.8881],
  'ICT': [37.6499, -97.4331], 'DSM': [41.5340, -93.6631], 'MSN': [43.1399, -89.3375],
  'GRB': [44.4851, -88.1296], 'ATW': [44.2581, -88.5191], 'GRR': [42.8808, -85.5228],
  'TVC': [44.7415, -85.5822], 'AZO': [42.2350, -85.5521], 'FWA': [40.9785, -85.1952],
  'SBN': [41.7087, -86.3173], 'LEX': [38.0365, -84.6059], 'TYS': [35.8110, -83.9940],
  'TRI': [36.4752, -82.4074], 'GSP': [34.8957, -82.2189], 'CHS': [32.8986, -80.0405],
  'SAV': [32.1276, -81.2021], 'JAX': [30.4941, -81.6879], 'PNS': [30.4734, -87.1866],
  'MOB': [30.6914, -88.2458], 'SHV': [32.4466, -93.8256], 'BTR': [30.5328, -91.1496],
  'DAY': [39.9024, -84.2194], 'CAK': [40.9161, -81.4422], 'MDT': [40.1935, -76.7634],
  'BTV': [44.4720, -73.1533], 'PWM': [43.6462, -70.3093], 'BGR': [44.8074, -68.8281],
};
...
export const HOTEL_MARKET_RATES: Record<string, { twoStar: number; threeStar: number; fourStar: number; fiveStar: number }> = {
  // USA — Major Markets
  'new york':        { twoStar: 180, threeStar: 280, fourStar: 420, fiveStar: 700 },
  'los angeles':     { twoStar: 150, threeStar: 240, fourStar: 360, fiveStar: 600 },
  'chicago':         { twoStar: 130, threeStar: 200, fourStar: 300, fiveStar: 500 },
  'san francisco':   { twoStar: 160, threeStar: 250, fourStar: 380, fiveStar: 620 },
  'boston':          { twoStar: 150, threeStar: 230, fourStar: 350, fiveStar: 580 },
  'miami':           { twoStar: 140, threeStar: 220, fourStar: 330, fiveStar: 550 },
  'seattle':         { twoStar: 130, threeStar: 200, fourStar: 300, fiveStar: 500 },
  'washington':      { twoStar: 140, threeStar: 220, fourStar: 330, fiveStar: 550 },
  'las vegas':       { twoStar: 80,  threeStar: 130, fourStar: 220, fiveStar: 400 },
  // USA — Secondary Markets
  'nashville':       { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'austin':          { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'denver':          { twoStar: 100, threeStar: 160, fourStar: 240, fiveStar: 380 },
  'atlanta':         { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'dallas':          { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 360 },
  'houston':         { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 360 },
  'phoenix':         { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'portland':        { twoStar: 100, threeStar: 160, fourStar: 240, fiveStar: 380 },
  'minneapolis':     { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'detroit':         { twoStar: 90,  threeStar: 140, fourStar: 200, fiveStar: 320 },
  'philadelphia':    { twoStar: 120, threeStar: 185, fourStar: 270, fiveStar: 440 },
  'san diego':       { twoStar: 130, threeStar: 200, fourStar: 300, fiveStar: 480 },
  'new orleans':     { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'pittsburgh':      { twoStar: 90,  threeStar: 140, fourStar: 200, fiveStar: 320 },
  'cleveland':       { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'st. louis':       { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'st louis':        { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'baltimore':       { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'salt lake city':  { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'kansas city':     { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'indianapolis':    { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'columbus':        { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'charlotte':       { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'raleigh':         { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'orlando':         { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'tampa':           { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'memphis':         { twoStar: 80,  threeStar: 125, fourStar: 180, fiveStar: 290 },
  'richmond':        { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'milwaukee':       { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'louisville':      { twoStar: 80,  threeStar: 125, fourStar: 180, fiveStar: 290 },
  'oklahoma city':   { twoStar: 80,  threeStar: 120, fourStar: 175, fiveStar: 280 },
  'tulsa':           { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'sacramento':      { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'san jose':        { twoStar: 130, threeStar: 200, fourStar: 300, fiveStar: 480 },
  'buffalo':         { twoStar: 80,  threeStar: 120, fourStar: 175, fiveStar: 280 },
  'boise':           { twoStar: 80,  threeStar: 120, fourStar: 175, fiveStar: 280 },
  'spokane':         { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'tucson':          { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'albuquerque':     { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'omaha':           { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'des moines':      { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  // USA — Small Markets
  'asheville':       { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'chattanooga':     { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'knoxville':       { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'birmingham':      { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'little rock':     { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'jackson':         { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'fargo':           { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'sioux falls':     { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'missoula':        { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'bozeman':         { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'madison':         { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'grand rapids':    { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'lexington':       { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'savannah':        { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'charleston':      { twoStar: 80,  threeStar: 120, fourStar: 175, fiveStar: 280 },
  'greenville':      { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'iowa city':       { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'lincoln':         { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'wichita':         { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'reno':            { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  'boulder':         { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'aspen':           { twoStar: 150, threeStar: 240, fourStar: 380, fiveStar: 650 },
  'anchorage':       { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'honolulu':        { twoStar: 130, threeStar: 200, fourStar: 310, fiveStar: 520 },
  // Canada
  'toronto':         { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'montreal':        { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'vancouver':       { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'calgary':         { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'edmonton':        { twoStar: 90,  threeStar: 140, fourStar: 200, fiveStar: 320 },
  'ottawa':          { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'winnipeg':        { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'halifax':         { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  // UK
  'london':          { twoStar: 140, threeStar: 220, fourStar: 340, fiveStar: 580 },
  'manchester':      { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'glasgow':         { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'edinburgh':       { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'birmingham uk':   { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'leeds':           { twoStar: 80,  threeStar: 125, fourStar: 180, fiveStar: 290 },
  'bristol':         { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'liverpool':       { twoStar: 80,  threeStar: 125, fourStar: 180, fiveStar: 290 },
  'dublin':          { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  // Europe
  'paris':           { twoStar: 130, threeStar: 200, fourStar: 320, fiveStar: 540 },
  'berlin':          { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'amsterdam':       { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'madrid':          { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'barcelona':       { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'rome':            { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'milan':           { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'vienna':          { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'brussels':        { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'stockholm':       { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'oslo':            { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'copenhagen':      { twoStar: 105, threeStar: 165, fourStar: 245, fiveStar: 395 },
  'zurich':          { twoStar: 130, threeStar: 200, fourStar: 310, fiveStar: 520 },
  'prague':          { twoStar: 70,  threeStar: 105, fourStar: 155, fiveStar: 250 },
  'budapest':        { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'warsaw':          { twoStar: 65,  threeStar: 100, fourStar: 145, fiveStar: 235 },
  'lisbon':          { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'hamburg':         { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'munich':          { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'frankfurt':       { twoStar: 95,  threeStar: 150, fourStar: 220, fiveStar: 350 },
  'cologne':         { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  'reykjavik':       { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  // Australia
  'sydney':          { twoStar: 110, threeStar: 170, fourStar: 260, fiveStar: 420 },
  'melbourne':       { twoStar: 100, threeStar: 155, fourStar: 230, fiveStar: 370 },
  'brisbane':        { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'perth':           { twoStar: 90,  threeStar: 140, fourStar: 210, fiveStar: 340 },
  'adelaide':        { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
};

export const HOTEL_FALLBACK_RATES = {
  usa:       { twoStar: 75,  threeStar: 115, fourStar: 165, fiveStar: 265 },
  canada:    { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  uk:        { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  europe:    { twoStar: 80,  threeStar: 125, fourStar: 180, fiveStar: 290 },
  australia: { twoStar: 85,  threeStar: 130, fourStar: 190, fiveStar: 300 },
  other:     { twoStar: 70,  threeStar: 110, fourStar: 160, fiveStar: 260 },
};
